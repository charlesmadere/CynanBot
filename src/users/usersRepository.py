...
class UsersRepository(UsersRepositoryInterface):
    ...
    def __createUser(self, handle: str, userJson: dict[str, Any]) -> User:
        ...
        isNotifyOfHypeTrainProgressEnabled = utils.getBoolFromDict(userJson, UserJsonConstant.NOTIFY_OF_HYPE_TRAIN_PROGRESS_ENABLED.jsonKey, False)
        isNotifyOfHypeTrainStartEnabled = utils.getBoolFromDict(userJson, UserJsonConstant.NOTIFY_OF_HYPE_TRAIN_START_ENABLED.jsonKey, False)
