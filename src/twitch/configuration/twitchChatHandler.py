...
class TwitchChatHandler(AbsTwitchChatHandler):
    ...
    async def onNewChat(
        ...
        if not utils.isValidStr(chatterUserId) or not utils.isValidStr(chatterUserLogin) or not utils.isValidStr(chatterUserName) or chatMessage is None:
            self.__timber.log('TwitchCheerHandler', f'Received a data bundle that is missing crucial data: ({user=}) ({dataBundle=}) ({chatterUserId=}) ({chatterUserLogin=}) ({chatterUserName=}) ({chatMessage=})')
            return
    ...
    async def __processSuperTriviaEvent(
        ...
        self.__timber.log('TwitchChatHandler', f'processSuperTriviaEvent #1: ({broadcasterUserId=}) ({cheer=}) ({user=}) ({bits=}) ({superTriviaCheerTriggerAmount=}) ({superTriviaCheerTriggerMaximum=})')
        ...
        # TODO delete this after doing some debugging
        self.__timber.log('TwitchChatHandler', f'processSuperTriviaEvent #4: ({broadcasterUserId=}) ({cheer=}) ({user=}) ({bits=}) ({superTriviaCheerTriggerAmount=}) ({superTriviaCheerTriggerMaximum=}) ({numberOfGames=}) ({action=})')
