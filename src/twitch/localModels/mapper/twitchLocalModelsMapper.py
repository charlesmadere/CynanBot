...
class TwitchLocalModelsMapper(TwitchLocalModelsMapperInterface):
    ...
    async def mapHypeTrainState(
        ...
        if websocketSubscriptionType is None:
            return None

        match websocketSubscriptionType:
            case ApiWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_BEGIN: return LocalHypeTrainState.BEGIN
            case ApiWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_END: return LocalHypeTrainState.END
            case ApiWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_PROGRESS: return LocalHypeTrainState.PROGRESS
            case _: return None
