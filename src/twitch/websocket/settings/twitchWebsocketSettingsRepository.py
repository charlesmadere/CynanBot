...
class TwitchWebsocketSettingsRepository(TwitchWebsocketSettingsRepositoryInterface):
    ...
    def __init__(
        ...
        defaultSubscriptionTypes: frozenset[TwitchWebsocketSubscriptionType] = frozenset({
            ...
            TwitchWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_BEGIN,
            TwitchWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_END,
            TwitchWebsocketSubscriptionType.CHANNEL_HYPE_TRAIN_PROGRESS,
