...
class AddRecurringSuperTriviaActionChatCommand(AbsChatCommand2):
    ...
    def __init__(
        ...
        self.__commandPatterns: Final[Collection[Pattern]] = frozenset({
            re.compile(r'^\s*!addrecurringsupertrivia(?:action)?\b', re.IGNORECASE),
        })

    @property
    def commandName(self) -> str:
        return 'AddRecurringSuperTriviaActionChatCommand'
    ...
    async def handleChatCommand(self, chatMessage: TwitchChatMessage) -> ChatCommandResult:
        ...
        if wizard.currentStep is not SuperTriviaStep.MINUTES_BETWEEN:
