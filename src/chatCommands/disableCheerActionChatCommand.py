...
class DisableCheerActionChatCommand(AbsChatCommand2):
    ...
    async def handleChatCommand(self, chatMessage: TwitchChatMessage) -> ChatCommandResult:
        ...
        if isinstance(result, AlreadyDisabledEditCheerActionResult):
            ...
            self.__timber.log(self.commandName, f'An unknown error occurred when trying to disable cheer action ({result=}) ({bits=}) ({bitsString=}) ({chatMessage=})')
