...
class GetChatterPreferredTtsChatCommand(AbsChatCommand):
    ...
    async def handleChatCommand(self, ctx: TwitchContext):
        ...
        try:
            ...
            self.__timber.log('GetChatterPreferredTtsChatCommand', f'Failed to find user ID information for {ctx.getAuthorName()}:{ctx.getAuthorId()} in {user.handle} ({messageContent=})', e, traceback.format_exc())
