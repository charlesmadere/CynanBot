...
from .cutenessSettingsInterface import CutenessSettingsInterface
from ...misc import utils as utils
from ...storage.jsonReaderInterface import JsonReaderInterface


class CutenessSettings(CutenessSettingsInterface):
    ...
    async def __readJson(self) -> dict[str, Any]:
        ...
        if not isinstance(jsonContents, dict):
            raise IOError(f'Error reading from Cuteness settings file: {self.__settingsJsonReader}')
