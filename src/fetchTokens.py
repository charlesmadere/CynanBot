...
# important keys / tokens that are required in order for some Twitch-related functionality in
# CynanBot to authenticate with Twitch and run properly.
#
...
# https://id.twitch.tv/oauth2/authorize?response_type=code&client_id=CLIENT_ID_HERE&redirect_uri=http://localhost&scope=channel:bot+chat:read+user:read:chat+user:bot+user:write:chat+chat:edit+channel_editor+channel:read:redemptions+channel:manage:redemptions+channel:read:subscriptions+channel:read:polls+channel:read:predictions+channel:manage:predictions+channel_subscriptions+moderator:read:chatters+user:read:chat+bits:read+moderator:read:followers+moderator:manage:banned_users+channel:manage:moderators+moderation:read+channel:manage:polls+user:read:subscriptions+channel:read:editors+moderator:manage:announcements+channel:edit:commercial+channel:manage:ads+channel:read:ads+moderator:read:moderators+channel:manage:broadcast+channel:read:hype_train+moderator:read:chat_messages+moderator:read:banned_users+moderator:manage:chat_messages+channel:read:vips+user:read:follows+user:read:emotes+moderator:read:chat_settings+moderator:manage:chat_settings+moderator:read:vips
