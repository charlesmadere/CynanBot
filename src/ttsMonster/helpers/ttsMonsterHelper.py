...
class TtsMonsterHelper(TtsMonsterHelperInterface):
    ...
    async def __saveSpeechBytes(
        ...
        try:
            ...
            self.__timber.log('TtsMonsterHelper', f'Encountered exception when trying to write TTS Monster speechBytes to file ({fileName=}) ({filePath=})', e, traceback.format_exc())
            return False
